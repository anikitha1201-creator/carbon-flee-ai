      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className="hover:shadow-md transition-shadow cursor-default">
            ...
            <CardContent>
              <div className="text-2xl font-bold">12,482 kg</div>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-default">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                8 EVs charging at low-carbon peak
              </p>
            </CardContent>
          </Card>
          <Card className="hover:shadow-md transition-shadow cursor-default">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Avg. Cost / Delivery</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
                <span className="text-accent flex items-center font-bold">
                  <TrendingDown className="h-3 w-3" /> -8%
                </span>
                fuel cost reduction
              </p>
            </CardContent>
        ...
        <div className="grid gap-6 md:grid-cols-7">
          <Card className="md:col-span-4 overflow-hidden border-none shadow-xl bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
             <div className="relative p-8 flex flex-col h-full justify-between">
                <div>
                  <Badge variant="secondary" className="mb-4 bg-white/20 hover:bg-white/30 text-white border-none backdrop-blur-md px-3 py-1">Featured Tool</Badge>
                  <h2 className="text-3xl font-bold mb-4 leading-tight">AI Carbon-Aware Routing</h2>
                  <p className="text-primary-foreground/80 max-w-md text-lg">
                    Automatically optimize your delivery schedule based on real-time grid carbon intensity. Prioritize renewable energy peaks and minimize your footprint.
                  </p>
                </div>
                <div className="flex gap-4 mt-8">
                  <Button variant="secondary" className="bg-white text-primary hover:bg-white/90">Optimize Routes</Button>
                  <Button variant="outline" className="border-white/40 text-white hover:bg-white/10">View Analysis</Button>
                </div>
          ...
          <Card className="md:col-span-3">
            <CardHeader>
              ...
              <CardDescription>Breakdown by vehicle power type</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="pt-4 border-t flex items-center justify-between text-xs text-muted-foreground">
                 ...
                 <span className="text-accent font-semibold underline cursor-pointer">View full fleet</span>
              </div>
            </CardContent>
          </Card>
        </div>
